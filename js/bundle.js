...
},{"./components/CRMContactsApp.react":2,"react":146}],2:[function(require,module,exports){
/**
 * @jsx React.DOM
 */
...
var CRMContactsApp = React.createClass({displayName: 'CRMContactsApp',

    render: function() {
        return (
            React.DOM.div({className: "js-crm-contacts"}, 
...
function validateLifeCycleOnReplaceState(instance) {
  ...
  ("production" !== "dev" ? invariant(
    ...
    compositeLifeCycleState === CompositeLifeCycle.MOUNTING));
  ("production" !== "dev" ? invariant(compositeLifeCycleState !== CompositeLifeCycle.RECEIVING_STATE,
    'replaceState(...): Cannot update during an existing state transition ' +
    '(such as within `render`). This could potentially cause an infinite ' +
    'loop so it is forbidden.'
  ) : invariant(compositeLifeCycleState !== CompositeLifeCycle.RECEIVING_STATE));
  ("production" !== "dev" ? invariant(compositeLifeCycleState !== CompositeLifeCycle.UNMOUNTING,
    ...
    for (var propName in propTypes) {
      if (propTypes.hasOwnProperty(propName)) {
        ...
        if (error instanceof Error) {
          ...
          ("production" !== "dev" ? warning(false, error.message + addendum) : null);
        }
      }
    }
  },
...
function getEventKey(nativeEvent) {
  ...
  ("production" !== "dev" ? invariant(false, "Unexpected keyboard event type: %s", nativeEvent.type) : invariant(false));
}
